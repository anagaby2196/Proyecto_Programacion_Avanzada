...
namespace Clinica.DAL
{
    ...
    public partial class ClinicaMedicaV1Entities : DbContext
    {
        ...
        public virtual int insertarPersona(string nombre, string pRIMERAPELLIDO, string segundoApellido, string identificacion, string telefono, string correo, Nullable<int> tipoUsuarioFK)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("nombre", nombre) :
                new ObjectParameter("nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("insertarPersona", nombreParameter, pRIMERAPELLIDOParameter, segundoApellidoParameter, identificacionParameter, telefonoParameter, correoParameter, tipoUsuarioFKParameter);
        }
